...
test_that("Package output matches TAXSIM test file", {
  ...
  taxsim_output_ftp <- taxsim_calculate_taxes(taxsim_input, upload_method = 'ftp')
  taxsim_output_ssh <- taxsim_calculate_taxes(taxsim_input, upload_method = 'ssh')
  ...
  taxsim_output <- taxsim_calculate_taxes(taxsim_input, upload_method = 'ftp')
