...
#'
#' \code{.data} is the only required parameter. It represents a data set that will be sent to TAXSIM 32 and
#'     must have pre-specified column names and data types. The columns represent types of information that
#'     are needed to calculate taxes.
#'
#' @section Required and optional columns:
#'
...
#' )
#'
#' taxes <- taxsim_calculate_taxes(family_income)
#'
#' merge(family_income, taxes, by = 'id_number')
#'
