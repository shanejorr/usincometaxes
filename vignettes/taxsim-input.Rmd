...
**Legacy Dependent Fields (TAXSIM 32 Compatibility)**

The following fields provide an alternative method for specifying dependents and are maintained for backward compatibility with older TAXSIM versions. Use either these fields OR the age1/age2/age3 fields above, not both.

* **dep13**: Number of dependents under age 13.
<br>
* **dep17**: Number of dependents under age 17.
<br>
* **dep18**: Number of dependents age 18 or older.
<br>
...
<br>
* **mortgage**: Deductions not included above and not a preference for the AMT. This field consolidates several Schedule A deductions including:
    * Home mortgage interest (Schedule A Line 15);
    * Deductible medical expenses not included in Line 16;
    * Motor Vehicle Taxes paid (Schedule A Line 7);
    * Charitable contributions (Schedule A Line 19); and
    * Casualty or Theft Losses (Schedule A Line 20).
<br>
