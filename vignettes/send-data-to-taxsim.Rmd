...
Now, manually upload the  file `taxsim_dataset.csv` to TAXSIM 35's server by going to (https://users.nber.org/~taxsim/taxsim35/), navigating to the following section of the page, and uploading the `.csv` file:

```{r pic, echo=FALSE, warning = FALSE, fig.cap="", out.width = '75%'}
