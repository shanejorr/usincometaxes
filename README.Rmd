...
The input data frame, `.data`, must contain three required columns. Optional columns can also be specified 
for better tax calculations. All columns must have the column names and data types listed in the 
