...
`usincometaxes` calculates federal and state income taxes in the United States.
...
`.data` is the only parameter for `taxsim_calculate_taxes()`. It is a data frame containing the information
used to calculate taxes. Column names must match the names below.
